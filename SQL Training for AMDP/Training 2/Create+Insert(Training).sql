...
CREATE TABLE MsProduct(
	...
	IDShop VARCHAR(6) FOREIGN KEY REFERENCES TrShop(IDShop),
	Name VARCHAR(50) NOT NULL,
	Stock INT NOT NULL,
...
CREATE TABLE TrTransaction(
	IDTransaction VARCHAR(5) PRIMARY KEY,
	IDProduct INT FOREIGN KEY REFERENCES MsProduct(IDProduct),
	IDCustomer INT FOREIGN KEY REFERENCES TrCustomer(IDCustomer),
...
CREATE TABLE TrReview(
	...
	Comment VARCHAR(50),
	Star INT NOT NULL,
	CONSTRAINT checkStar CHECK (Star >= 1 and Star <= 5)
)
...
UPDATE trcustomer set name = 'Christiana Willis Cockle' where IDCustomer = 1
UPDATE trcustomer set name = 'Suzanne Jones Greenway' where IDCustomer = 3
UPDATE trcustomer set name = 'Beth Giantbulb Barlow' where IDCustomer = 5
UPDATE trcustomer set name = 'Jeff Ferguson Platt' where IDCustomer = 7
UPDATE trcustomer set name = 'Charlotte Donaldson Hemingway' where IDCustomer = 9
